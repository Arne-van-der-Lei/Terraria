...
typedef struct
{
    ...
    float y;        /* FileManager co-ordinate in 3D space. */
...
#define FMOD_INIT_3D_RIGHTHANDED             0x00000004 /* FMOD will treat +X as right, +FileManager as up and +Z as backwards (towards you). */
